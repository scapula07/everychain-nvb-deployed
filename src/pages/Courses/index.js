            ...
            <main className='flex  px-8 justify-between '>
                <div className='flex space-x-4'>
                  <main className="p-2 w-1/2 h-44 -mt-6 rounded-lg bg-purple-900 ">
                    <img src={locationState.course.imgUrl} className="w-full h-full  rounded-lg"/>

                  </main>
                 
                  <h5 className='pt-2'>
                   <span className='font-semibold text-sm'>{locationState.course.name} </span> 
                  
                  </h5>
                </div>

                <div className='flex items-center space-x-6'>
                <button className='bg-rose-900 space-x-1  px-2 py-2 rounded-sm text-xs font-semibold'>Add to cart</button>
                   <button className='bg-rose-900 space-x-1  px-2 py-2 rounded-sm text-xs font-semibold'>Buy now</button>
                </div>
         ...
         <div className='flex pt-44 space-x-4'>
                ...
                <div className='flex flex-col py-1 px-4'>
                   <main className='flex items-center justify-between'>
                     ...
                     <h5 className='flex flex-col text-xs'>
                        <span>Name</span>
                        <span>{locationState.course.name} </span>
                     </h5>
                     <h5 className='flex flex-col text-xs'>
               ...
               <h5 className='font-semibold text-sm'>About </h5>
                <div className='flex items-center justify-between pt-4'>
                   <main className='flex space-x-4'>
                      <img  src={locationState.course.imgUrl} className="h-10 w-10 rounded-full"/>
            ...
            <main className='w-1/5 pt-4' >
               ...
               <div className='pt-4 flex justify-center '>
                   <button className='bg-rose-900 space-x-1  px-4 py-2 rounded-sm text-xs font-semibold' onClick={()=>setHireTrigger(true)}>Buy now</button>
                </div>
            </main>
